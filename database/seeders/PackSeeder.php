    ...
    public function run(): void
    {
        $packs = [
            ...
            [
                ...
                'price'       => 15000,
                'period'      => 'monthly',
                'features'    => ['dashboard', 'products', 'customers', 'orders', 'expenses', 'reports', 'accounting', 'settings'],
            ...
            [
                ...
                'price'       => 35000,
                'period'      => 'monthly',
                'features'    => ['dashboard', 'products', 'customers', 'suppliers', 'purchase-orders', 'expenses', 'orders', 'reports', 'production', 'accounting', 'settings'],
            ...
            [
                ...
                'price'       => 75000,
                'period'      => 'monthly',
                'features'    => ['dashboard', 'products', 'customers', 'suppliers', 'purchase-orders', 'expenses', 'pos', 'orders', 'reports', 'production', 'accounting', 'credit', 'settings'],
